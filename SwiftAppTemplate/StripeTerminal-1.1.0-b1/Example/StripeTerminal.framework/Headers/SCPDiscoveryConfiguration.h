...
/**
 ...
 | DeviceType   | valid DiscoveryMethods                               | simulated |
 | ------------ | -----------------------------------------------------|-----------|
 | chipper2X    | bluetoothProximity (recommended), bluetoothScan      | YES       |
 | verifoneP400 | internet                                             | NO        |
...
/**
 ...
 | DeviceType   | valid DiscoveryMethods                               | locationId | simulated |
 | ------------ | -----------------------------------------------------|------------|-----------|
 | chipper2X    | bluetoothProximity (recommended), bluetoothScan      | NO         | YES       |
 | verifoneP400 | internet                                             | YES        | NO        |
