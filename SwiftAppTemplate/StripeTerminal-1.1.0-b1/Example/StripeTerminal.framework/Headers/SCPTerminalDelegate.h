...
@optional
/**
 The terminal reported an event from the reader (e.g. a card was inserted). Note
 the `verifoneP400` has a built-in display, which handles displaying card and
 payment events to the customer so this will not invoked if connect to a reader
 of that type.
...
/**
 The terminal's `connectedReader` has a low battery. This will not be invoked
 if you are connected to a `verifoneP400` since it is plugged into the wall.
