...
typedef NS_ERROR_ENUM(SCPErrorDomain, SCPError) {
    ...
    /**
     ...
     be connected to. The IP address should be set during registration of the
     reader, try registering the reader again.
    ...
    /**
     ...
     and `SCPConnectConfiguration.failIfInUse` was set to `true`.
